          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <Badge
                variant="outline"
                className={
                  "bg-emerald-900 border-emerald-700/30 px-4 py-2 text-emerald-400 text-sm font-medium"
                }
              >
              ...
              <p className="text-muted-foreground text-lg md:text-xl max-wd-md">
            ...
            <div className="h-100 relative lg:h-125">
              <Image
                className="object-cover md:pt-14 rounded-xl"
                src={"/banner2.png"}
                alt="Doctor consulation"
                fill
                priority
              />
            </div>
      ...
      <section className="py-20 bg-muted-30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Out platform makes healthcare accessible with just a few click
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => {
            return (
              <Card key={idx} className={"border-emerald-900/20 hover:border-emerald-800/40 transition-all duration-300"}>
                <CardHeader className={"pb-2"}>
                  <div className="bg-emerald-900/20 p-3 rounded-lg w-fit mb-14">
                    {feature.icon}
                  </div>
